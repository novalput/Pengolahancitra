...
image_path = 'assets/durian.jpg'   # Pastikan file 1.jpg ada di folder assets
...
# Menggunakan intensitas piksel untuk segmentasi
...
# Menentukan marker sederhana (bisa disesuaikan dengan histogram citra assets/1.jpg)
markers = np.zeros_like(image_gray)
markers[image_gray < 0.2] = 1 # Marker latar belakang (asumsi gelap)
markers[image_gray > 0.7] = 2 # Marker objek (asumsi terang)
